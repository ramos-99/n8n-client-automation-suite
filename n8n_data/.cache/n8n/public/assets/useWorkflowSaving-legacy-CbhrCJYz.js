;
(function () {
  System.register(["./_MapCache-legacy-Dnvl_Nsb.js", "./useMessage-legacy-DNyf8RAT.js", "./useTelemetry-legacy-DDadbM-F.js", "./useToast-legacy-mgI0JreW.js", "./constants-legacy-ChKQ_dFa.js", "./useExternalHooks-legacy-9B_pHzUT.js", "./npsSurvey.store-legacy-5PS1YJ8J.js", "./templates.store-legacy-Coq6ILHm.js", "./focusPanel.store-legacy-BQl8FrOJ.js"], function (_export, _context) {
    "use strict";

    var useI18n, useMessage, tryToParseNumber, useUIStore, useSourceControlStore, useCanvasStore, injectWorkflowState, useWorkflowHelpers, useWorkflowsStore, useNodeTypesStore, useTelemetry, useNodeHelpers, useToast, NON_ACTIVATABLE_TRIGGER_NODE_TYPES, VIEWS, MODAL_CONFIRM, getResourcePermissions, MODAL_CANCEL, MODAL_CLOSE, PLACEHOLDER_EMPTY_WORKFLOW_ID, useExternalHooks, useNpsSurveyStore, useTemplatesStore, useFocusPanelStore;
    ...
    return {
      setters: [function (_MapCacheLegacy005Js) {
        ...
        MODAL_CANCEL = _constantsLegacy00RJs.Xo;
        MODAL_CLOSE = _constantsLegacy00RJs.Zo;
