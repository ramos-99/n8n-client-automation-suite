;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Dnvl_Nsb.js", "./src-legacy-ovK6Yepc.js", "./en-legacy-DJK4SpPN.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-FGoq5HUU.js", "./icon-legacy-CGCHLh4c.js", "./date-picker-legacy-BXKZ0TtA.js", "./overlay-legacy-BE4EX41P.js", "./ParameterInputList-legacy-egAxuGrP.js", "./empty-legacy-ZG0-xpne.js", "./useMessage-legacy-DNyf8RAT.js", "./col-legacy-B_FNKdeb.js", "./dialog-legacy-CldjooCJ.js", "./useTelemetry-legacy-DDadbM-F.js", "./useToast-legacy-mgI0JreW.js", "./sanitize-html-legacy-D7fDKXy5.js", "./path-browserify-legacy-BRGcgaOH.js", "./constants-legacy-ChKQ_dFa.js", "./merge-legacy-3m9P34FL.js", "./assistant.store-legacy-CsRYRswL.js", "./_baseOrderBy-legacy-BPTF6GmT.js", "./dateformat-legacy-C7RFTAF8.js", "./useDebounce-legacy-C62RhzIG.js", "./useExternalHooks-legacy-9B_pHzUT.js", "./useStyles-legacy-CJudPaTy.js", "./chatPanel.store-legacy-DC_rvvSe.js", "./npsSurvey.store-legacy-5PS1YJ8J.js", "./cloudPlan.store-legacy-D1meWtN_.js", "./templates.store-legacy-Coq6ILHm.js", "./focusPanel.store-legacy-BQl8FrOJ.js", "./useWorkflowSaving-legacy-CbhrCJYz.js", "./retry-legacy-CSXRWnZ-.js", "./executions.store-legacy-BSmK2wYL.js", "./useRunWorkflow-legacy-B9DJIVrX.js", "./usePinnedData-legacy-D9qWgS53.js", "./nodeCreator.store-legacy-Cz7MT2yw.js", "./nodeIcon-legacy-BDR7mI3b.js", "./useClipboard-legacy-oCuG5psd.js", "./useCanvasOperations-legacy-jGTblFvL.js", "./folders.store-legacy-C0hwiE2m.js", "./NodeIcon-legacy-CdcdwuK1.js", "./KeyboardShortcutTooltip-legacy-C63GjBDB.js", "./useCanvasMapping-legacy-DhRnNCqd.js", "./versions.store-legacy-BkNnYSUU.js", "./usePageRedirectionHelper-legacy-Bp2UduOu.js", "./dataTable.store-legacy-Cd3rJYtZ.js", "./isEmpty-legacy-Bp6_KD8L.js", "./NDVEmptyState-legacy-C-3u2C0Y.js", "./exports-legacy-DPuVuwu3.js", "./externalSecrets.ee.store-legacy-BeMjgDas.js", "./uniqBy-legacy-DLCGw2JU.js", "./semver-legacy-BzoZT7db.js", "./CommunityNodeUpdateInfo-legacy-BL-uFwIk.js", "./RunDataHtml-legacy-3uzev81-.js", "./VueMarkdown-legacy-DTlDGKgB.js", "./Draggable-legacy-C_x_7ozS.js", "./VirtualSchema-legacy-BhL_UpLI.js", "./TextWithHighlights-legacy-C8fykrgk.js", "./useTelemetryContext-legacy-C5WtVzwm.js", "./schemaPreview.store-legacy-CZbn2cgF.js", "./nodeTransforms-legacy-DgwkgU1m.js", "./FileSaver.min-legacy-CcqEXadD.js", "./vue-json-pretty-legacy-CpZv9WKV.js", "./dateFormatter-legacy-D3yx565r.js", "./useExecutionHelpers-legacy-DxwCfvUi.js", "./NodeSettings-legacy-D-ZSjFl0.js", "./useActions-legacy-drWnci3G.js", "./vue-legacy-Dssj0V9e.js", "./sourceControl.eventBus-legacy-D0Iovp14.js", "./useKeybindings-legacy-D2MUCvKA.js", "./useBeforeUnload-legacy-Db8gDxsU.js", "./aiTemplatesStarterCollection.store-legacy-CqGtCGB3.js", "./useExecutionData-legacy-KsWxKnZZ.js", "./useExecutionDebugging-legacy-BiqC1dK2.js", "./readyToRunWorkflows.store-legacy-B0iyZ2SX.js"], function (_export, _context) {
    "use strict";

    var computed, toDisplayString, createElementBlock, createCommentVNode, nextTick, unref, ref, onBeforeUnmount, onActivated, h, createVNode, defineAsyncComponent, defineComponent, reactive, onUnmounted, createBlock, toRef, mergeProps, onDeactivated, onMounted, Fragment, watch, renderSlot, normalizeStyle, withCtx, useCssModule, openBlock, withModifiers, renderList, createTextVNode, useTemplateRef, provide, onBeforeMount, normalizeClass, createBaseVNode, Suspense, refThrottled, useActiveElement, useI18n, useThrottleFn, N8nIconButton_default, N8nInfoTip_default, N8nCallout_default, N8nText_default, CanvasThinkingPill_default, N8nRadioButtons_default, N8nIcon_default, N8nInlineTextEdit_default, N8nResizeWrapper_default, useDeviceSupport, N8nButton_default, N8nKeyboardShortcut_default, N8nInput_default, __vitePreload, __plugin_vue_export_helper_default, useRouter, onBeforeRouteLeave, createEventBus, useRoute, HtmlEditor_default, SqlEditor_default, CodeNodeEditor_default, isValidParameterOption, ParameterOptions_default, getParameterTypeOption, JsEditor_default, CssEditor_default, formatAsExpression, useResolvedExpression, useNodeSettingsParameters, ExpressionEditorModalInput_default, parseFromExpression, useMessage, useSettingsStore, useCredentialsStore, getNodesWithNormalizedPosition, useDocumentTitle, useHistoryStore, nodeViewEventBus, useUIStore, htmlEditorEventBus, getSampleWorkflowByTemplateId, historyBus, CanvasNodeRenderType, useSourceControlStore, useCanvasStore, useVueFlow, isFocusableEl, useNDVStore, isValueExpression, injectWorkflowState, useUsersStore, getBounds, useTagsStore, usePostHog, globalLinkActionsEventBus, hasFocusOnInput, useWorkflowsStore, useNodeTypesStore, useTelemetry, useEnvironmentsStore, useProjectsStore, getNodeViewTab, useWorkflowState, useNodeHelpers, useToast, getNodeOutputs, CHAT_TRIGGER_NODE_TYPE, NODE_CREATOR_OPEN_SOURCES, jsonParse, FROM_AI_PARAMETERS_MODAL_KEY, VALID_WORKFLOW_IMPORT_URL_REGEX, MAIN_HEADER_TABS, VIEWS, ABOUT_MODAL_KEY, getNodeInputs, MODAL_CONFIRM, DRAG_EVENT_DATA_KEY, MANUAL_CHAT_TRIGGER_NODE_TYPE, getResourcePermissions, ExpressionLocalResolveContextSymbol, AI_TRANSFORM_NODE_TYPE, HTML_NODE_TYPE, isTriggerNode, NDV_UI_OVERHAUL_EXPERIMENT, EVALUATION_NODE_TYPE, WORKFLOW_SETTINGS_MODAL_KEY, START_NODE_TYPE, NEW_WORKFLOW_ID, WorkflowStateKey, PLACEHOLDER_EMPTY_WORKFLOW_ID, EnterpriseEditionFeature, EVALUATION_TRIGGER_NODE_TYPE, STICKY_NODE_TYPE, isResourceLocatorValue, useBuilderStore, useRootStore, useExternalHooks, useNpsSurveyStore, useFocusPanelStore, useWorkflowSaving, useExecutionsStore, usePushConnectionStore, useAgentRequestStore, useRunWorkflow, useNodeCreatorStore, shouldIgnoreCanvasShortcut, useClipboard, useLogsStore, useExperimentalNdvStore, useParentFolder, canvasEventBus, useCanvasOperations, NodeIcon_default, KeyboardShortcutTooltip_default, ExperimentalCanvasNodeSettings_default, useWorkflowExtraction, Canvas_default, useContextMenuItems, useExpressionResolveCtx, useCanvasMapping, CanvasRunWorkflowButton_default, JsonEditor_default, useExternalSecretsStore, NodeExecuteButton_default, useTelemetryContext, needsAgentInput, sourceControlEventBus, useKeybindings, useBeforeUnload, useAITemplatesStarterCollectionStore, useExecutionData, useExecutionDebugging, useReadyToRunWorkflowsStore, __vite_style__, WorkflowCanvas_vue_vue_type_script_setup_true_lang_default, wrapper$2, canvas, WorkflowCanvas_vue_vue_type_style_index_0_lang_module_default, cssModules$4, WorkflowCanvas_default, ExperimentalNodeDetailsDrawer_vue_vue_type_script_setup_true_lang_default, component$1, multipleNodes, multipleNodesActions, multipleNodesAction, ExperimentalNodeDetailsDrawer_vue_vue_type_style_index_0_lang_module_default, cssModules$3, ExperimentalNodeDetailsDrawer_default, ExperimentalFocusPanelHeader_vue_vue_type_script_setup_true_lang_default, component, breadcrumbs, ExperimentalFocusPanelHeader_vue_vue_type_style_index_0_lang_module_default, cssModules$2, ExperimentalFocusPanelHeader_default, FocusPanel_vue_vue_type_script_setup_true_lang_default, wrapper$1, container, content, emptyContent, isNdvInFocusPanelEnabled, emptyText, focusParameterWrapper, iconWrapper, pointerIcon, tabHeader, tabHeaderText, buttonWrapper, parameterDetailsWrapper, parameterOptionsWrapper, noExecutionDataTip, editorContainer, editor, delayedShow, triggerShow, closeButton, heightFull, forceHover, FocusPanel_vue_vue_type_style_index_0_lang_module_default, cssModules$1, FocusPanel_default, state, CanvasStopCurrentExecutionButton_vue_vue_type_script_setup_true_lang_default, CanvasStopCurrentExecutionButton_default, CanvasStopWaitingForWebhookButton_vue_vue_type_script_setup_true_lang_default, CanvasStopWaitingForWebhookButton_default, _hoisted_1, _hoisted_2, NodeViewUnfinishedWorkflowMessage_vue_vue_type_script_setup_true_lang_default, NodeViewUnfinishedWorkflowMessage_default, CanvasChatButton_vue_vue_type_script_setup_true_lang_default, CanvasChatButton_default, NodeView_vue_vue_type_script_setup_true_lang_default, wrapper, executionButtons, chatButton, setupCredentialsButtonWrapper, readOnlyEnvironmentNotification, thinkingPill, NodeView_vue_vue_type_style_index_0_lang_module_default, cssModules, NodeView_default;
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        N8nCallout_default = _srcLegacy007Js.Gn;
        ...
        useHistoryStore = _useTelemetryLegacy00HJs.Cr;
        nodeViewEventBus = _useTelemetryLegacy00HJs.Ei;
        useUIStore = _useTelemetryLegacy00HJs.Ni;
        htmlEditorEventBus = _useTelemetryLegacy00HJs.Oi;
        getSampleWorkflowByTemplateId = _useTelemetryLegacy00HJs.Ot;
        historyBus = _useTelemetryLegacy00HJs.Pr;
        CanvasNodeRenderType = _useTelemetryLegacy00HJs.Sr;
        useSourceControlStore = _useTelemetryLegacy00HJs.Tn;
        useCanvasStore = _useTelemetryLegacy00HJs.Un;
        useVueFlow = _useTelemetryLegacy00HJs.V;
        isFocusableEl = _useTelemetryLegacy00HJs._i;
        useNDVStore = _useTelemetryLegacy00HJs.a;
        isValueExpression = _useTelemetryLegacy00HJs.ai;
        injectWorkflowState = _useTelemetryLegacy00HJs.bn;
        useUsersStore = _useTelemetryLegacy00HJs.er;
        getBounds = _useTelemetryLegacy00HJs.g;
        useTagsStore = _useTelemetryLegacy00HJs.hn;
        usePostHog = _useTelemetryLegacy00HJs.i;
        globalLinkActionsEventBus = _useTelemetryLegacy00HJs.ki;
        hasFocusOnInput = _useTelemetryLegacy00HJs.mi;
        useWorkflowsStore = _useTelemetryLegacy00HJs.o;
        useNodeTypesStore = _useTelemetryLegacy00HJs.rt;
        useTelemetry = _useTelemetryLegacy00HJs.t;
        useEnvironmentsStore = _useTelemetryLegacy00HJs.vn;
        useProjectsStore = _useTelemetryLegacy00HJs.wn;
        getNodeViewTab = _useTelemetryLegacy00HJs.x;
        useWorkflowState = _useTelemetryLegacy00HJs.xn;
        useNodeHelpers = _useTelemetryLegacy00HJs.yn;
      }, function (_useToastLegacy00JJs) {
        useToast = _useToastLegacy00JJs.t;
      }, function (_sanitizeHtmlLegacy00LJs) {}, function (_pathBrowserifyLegacy00PJs) {}, function (_constantsLegacy00RJs) {
        getNodeOutputs = _constantsLegacy00RJs.$i;
        CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00RJs.Bt;
        NODE_CREATOR_OPEN_SOURCES = _constantsLegacy00RJs.Ct;
        jsonParse = _constantsLegacy00RJs.Da;
        FROM_AI_PARAMETERS_MODAL_KEY = _constantsLegacy00RJs.Go;
        VALID_WORKFLOW_IMPORT_URL_REGEX = _constantsLegacy00RJs.M;
        MAIN_HEADER_TABS = _constantsLegacy00RJs.Mo;
        VIEWS = _constantsLegacy00RJs.No;
        ABOUT_MODAL_KEY = _constantsLegacy00RJs.Po;
        ...
        ExpressionLocalResolveContextSymbol = _constantsLegacy00RJs.Ws;
        AI_TRANSFORM_NODE_TYPE = _constantsLegacy00RJs.Xa;
        HTML_NODE_TYPE = _constantsLegacy00RJs.ao;
        isTriggerNode = _constantsLegacy00RJs.da;
        NDV_UI_OVERHAUL_EXPERIMENT = _constantsLegacy00RJs.ec;
        EVALUATION_NODE_TYPE = _constantsLegacy00RJs.eo;
        WORKFLOW_SETTINGS_MODAL_KEY = _constantsLegacy00RJs.fs;
        START_NODE_TYPE = _constantsLegacy00RJs.lr;
        NEW_WORKFLOW_ID = _constantsLegacy00RJs.o;
        WorkflowStateKey = _constantsLegacy00RJs.qs;
        ...
        isResourceLocatorValue = _constantsLegacy00RJs.ya;
        ...
        useWorkflowExtraction = _useCanvasMappingLegacy01HJs.l;
        ...
        CanvasRunWorkflowButton_default = _useCanvasMappingLegacy01HJs.u;
      ...
      execute: function () {
        ...
        NodeView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          __name: "NodeView",
          setup(__props) {
            const LazyNodeCreation = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeCreation-legacy-QR6JPn-l.js"), true               ? void 0 : void 0));
            const LazyNodeDetailsView = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeDetailsView-legacy-DhLJZQqX.js"), true               ? void 0 : void 0));
            const LazyNodeDetailsViewV2 = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeDetailsViewV2-legacy-CBMsrvL_.js"), true               ? void 0 : void 0));
            const LazySetupWorkflowCredentialsButton = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./SetupWorkflowCredentialsButton-legacy-CUKJehNp.js"), true               ? void 0 : void 0));
            const $style = useCssModule();
