;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-DDadbM-F.js", "./_baseOrderBy-legacy-BPTF6GmT.js"], function (_export, _context) {
    "use strict";

    var computed, ref, UserManagementAuthenticationMethod, getLdapConfig, saveSamlConfig, testLdapConnection, getOidcConfig, saveOidcConfig, getSamlMetadata, testSamlConfig, initSSO, getSamlConfig, getLdapSynchronizations, updateLdapConfig, runLdapSync, defineStore, useRootStore, SupportedProtocols, useSSOStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        computed = _vueRuntimeEsmBundlerLegacy003Js.C;
        ref = _vueRuntimeEsmBundlerLegacy003Js.It;
      }, function (_useTelemetryLegacy00HJs) {
        UserManagementAuthenticationMethod = _useTelemetryLegacy00HJs.Zs;
        getLdapConfig = _useTelemetryLegacy00HJs._s;
        saveSamlConfig = _useTelemetryLegacy00HJs.as;
        testLdapConnection = _useTelemetryLegacy00HJs.bs;
        getOidcConfig = _useTelemetryLegacy00HJs.es;
        saveOidcConfig = _useTelemetryLegacy00HJs.is;
        getSamlMetadata = _useTelemetryLegacy00HJs.ns;
        testSamlConfig = _useTelemetryLegacy00HJs.os;
        initSSO = _useTelemetryLegacy00HJs.rs;
        getSamlConfig = _useTelemetryLegacy00HJs.ts;
        getLdapSynchronizations = _useTelemetryLegacy00HJs.vs;
        updateLdapConfig = _useTelemetryLegacy00HJs.xs;
        runLdapSync = _useTelemetryLegacy00HJs.ys;
