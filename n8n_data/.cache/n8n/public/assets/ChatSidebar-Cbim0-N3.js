...
import { A as useIntersectionObserver, D as useEventListener, M as useMediaQuery } from "./_MapCache-BMGgHHHp.js";
import { Et as N8nIconButton_default, Kn as N8nText_default, N as N8nLogo_default, Yn as N8nIcon_default, i as N8nScrollArea_default, nt as N8nActionDropdown_default, wt as N8nInput_default } from "./src-BSkvokO5.js";
...
import { t as ModalDrawer_default } from "./ModalDrawer-DxYUlr-0.js";
import { Bo as useSettingsStore, Ni as useUIStore, t as useTelemetry } from "./useTelemetry-B4fed6NY.js";
import { t as useToast } from "./useToast-CSbjPKgy.js";
import "./sanitize-html-CWrjF493.js";
import "./path-browserify-CcVVPqSM.js";
import { Lo as CHAT_HUB_SIDE_MENU_DRAWER_MODAL_KEY, No as VIEWS, Qo as MODAL_CONFIRM } from "./constants-CIzUKvWA.js";
...
import { f as unflattenModel, s as groupConversationsByDate, t as useChatStore } from "./chat.store-DtNmTfLe.js";
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass([_ctx.$style.component, { [_ctx.$style.isMobileDevice]: _ctx.isMobileDevice }]) }, [
				...
				createVNode(unref(N8nScrollArea_default), {
					...
					default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.items) }, [
						...
						(openBlock(true), createElementBlock(Fragment, null, renderList(groupedConversations.value, (group$1, index) => {
