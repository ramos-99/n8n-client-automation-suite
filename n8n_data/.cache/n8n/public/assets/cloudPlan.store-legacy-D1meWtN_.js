...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-DDadbM-F.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js"], function (_export, _context) {
    ...
    var computed, ref, reactive, useSettingsStore, hasPermission, getCloudUserInfo, getCurrentPlan, getAdminPanelLoginCode, getCurrentUsage, STORES, DateTime, CLOUD_TRIAL_CHECK_INTERVAL, defineStore, useRootStore, DEFAULT_STATE, DYNAMIC_TRIAL_BANNER_DISMISSED_KEY, useCloudPlanStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        getCloudUserInfo = _useTelemetryLegacy00HJs.Hs;
        getCurrentPlan = _useTelemetryLegacy00HJs.Us;
        getAdminPanelLoginCode = _useTelemetryLegacy00HJs.Vs;
        getCurrentUsage = _useTelemetryLegacy00HJs.Ws;
        STORES = _useTelemetryLegacy00HJs.ic;
      }, function (_constantsLegacy00RJs) {
        DateTime = _constantsLegacy00RJs.Ha;
        CLOUD_TRIAL_CHECK_INTERVAL = _constantsLegacy00RJs.lc;
