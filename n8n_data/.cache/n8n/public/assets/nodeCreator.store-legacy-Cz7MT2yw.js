;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Dnvl_Nsb.js", "./truncate-legacy-FGoq5HUU.js", "./useTelemetry-legacy-DDadbM-F.js", "./constants-legacy-ChKQ_dFa.js", "./merge-legacy-3m9P34FL.js", "./_baseOrderBy-legacy-BPTF6GmT.js", "./useExternalHooks-legacy-9B_pHzUT.js", "./templates.store-legacy-Coq6ILHm.js", "./nodeIcon-legacy-BDR7mI3b.js"], function (_export, _context) {
    "use strict";

    var __toESM, __commonJS, computed, nextTick, ref, useI18n, useRouter, require__arrayMap, require_get, require_toString, useRoute, isPrebuiltAgentTemplateId, useSettingsStore, transformNodeType, getRagStarterWorkflowJson, getPrebuiltAgents, v4_default, require_upperFirst, updateCurrentUserSettings, useUIStore, getSampleWorkflowByTemplateId, require__createCompounder, subcategorizeItems, useCanvasStore, getThemedValue, prepareCommunityNodeDetailsViewStack, useNDVStore, useEvaluationStore, CanvasConnectionMode, flattenCreateElements, useUsersStore, getPreBuiltAgentsCalloutWithDivider, isValidNodeConnectionType, isAINode, usePostHog, STORES, isTutorialTemplateId, getTutorialTemplates, isValidCanvasConnectionMode, groupItemsInSections, useWorkflowsStore, useNodeTypesStore, finalizeItems, useTelemetry, getAiTemplatesCallout, isVueFlowConnection, useProjectsStore, SampleTemplates, sortNodeCreateElements, searchNodes, AI_CATEGORY_LANGUAGE_MODELS, EDIT_IMAGE_NODE_TYPE, require__arrayIncludesWith, TRANSFORM_DATA_SUBCATEGORY, CHAT_TRIGGER_NODE_TYPE, LIMIT_NODE_TYPE, XML_NODE_TYPE, NODE_CREATOR_OPEN_SOURCES, MARKDOWN_NODE_TYPE, REGULAR_NODE_CREATOR_VIEW, MANUAL_TRIGGER_NODE_TYPE, CODE_NODE_TYPE, CUSTOM_API_CALL_KEY, AI_TRANSFORM_NODE_TYPE$1, CRYPTO_NODE_TYPE, VIEWS, AGGREGATE_NODE_TYPE, AI_CODE_NODE_TYPE, AI_CATEGORY_EMBEDDING, getNodeInputs, SCHEDULE_TRIGGER_NODE_TYPE, HUMAN_IN_THE_LOOP_CATEGORY, isCommunityPackageName, NodeConnectionTypes, COMPRESSION_NODE_TYPE, CONVERT_TO_FILE_NODE_TYPE, AI_CATEGORY_CHAINS, AI_TRANSFORM_NODE_TYPE, RSS_READ_NODE_TYPE, DATA_TABLE_NODE_TYPE, AI_CATEGORY_AGENTS, REMOVE_DUPLICATES_NODE_TYPE, AI_CATEGORY_DOCUMENT_LOADERS, DATETIME_NODE_TYPE, IF_NODE_TYPE, WEBHOOK_NODE_TYPE, CORE_NODES_CATEGORY, AI_CATEGORY_ROOT_NODES, require__cacheHas, HELPERS_SUBCATEGORY, EXTRACT_FROM_FILE_NODE_TYPE, AI_CATEGORY_VECTOR_STORES, FORM_TRIGGER_NODE_TYPE, SUMMARIZE_NODE_TYPE, AI_NODE_CREATOR_VIEW, AI_CATEGORY_MCP_NODES, AI_OTHERS_NODE_CREATOR_VIEW, HTTP_REQUEST_NODE_TYPE, AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, AI_CATEGORY_RETRIEVERS, require__arrayIncludes, TRIGGER_NODE_CREATOR_VIEW, MERGE_NODE_TYPE, TEMPLATE_CATEGORY_AI, FILTER_NODE_TYPE, AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, HTML_NODE_TYPE, AI_UNCATEGORIZED_CATEGORY, PRE_BUILT_AGENTS_EXPERIMENT, EMAIL_SEND_NODE_TYPE, PRE_BUILT_AGENTS_MODAL_KEY, SPLIT_IN_BATCHES_NODE_TYPE, AI_CATEGORY_TEXT_SPLITTERS, AI_SUBCATEGORY, NODE_MIN_INPUT_ITEMS_COUNT, AI_CATEGORY_OUTPUTPARSER, require__baseFlatten, EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, SPLIT_OUT_NODE_TYPE, AI_CATEGORY_TOOLS, EMAIL_IMAP_NODE_TYPE, EVALUATION_TRIGGER_NODE_TYPE, SET_NODE_TYPE, AI_CATEGORY_MEMORY, DEFAULT_SUBCATEGORY, OTHER_TRIGGER_NODES_SUBCATEGORY, require__SetCache, HITL_SUBCATEGORY, FLOWS_CONTROL_SUBCATEGORY, require__baseUnary, require__baseRest, require_isArrayLikeObject, defineStore, useRootStore, useExternalHooks, useTemplatesStore, getNodeIconSource, require__baseDifference, require_difference, require_capitalize, require_camelCase, import_camelCase, KEYBOARD_ID_ATTR, WATCHED_KEYS, useKeyboardNavigation, __virtual_node_popularity_data_default, import_difference, nodePopularityMap, useViewStacks, import_get, useNodeCreatorStore;
    //#endregion
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        isPrebuiltAgentTemplateId = _useTelemetryLegacy00HJs.At;
        useSettingsStore = _useTelemetryLegacy00HJs.Bo;
        transformNodeType = _useTelemetryLegacy00HJs.Ct;
        getRagStarterWorkflowJson = _useTelemetryLegacy00HJs.Dt;
        getPrebuiltAgents = _useTelemetryLegacy00HJs.Et;
        v4_default = _useTelemetryLegacy00HJs.Io;
        require_upperFirst = _useTelemetryLegacy00HJs.It;
        updateCurrentUserSettings = _useTelemetryLegacy00HJs.Ko;
        useUIStore = _useTelemetryLegacy00HJs.Ni;
        getSampleWorkflowByTemplateId = _useTelemetryLegacy00HJs.Ot;
        require__createCompounder = _useTelemetryLegacy00HJs.Rt;
        subcategorizeItems = _useTelemetryLegacy00HJs.St;
        useCanvasStore = _useTelemetryLegacy00HJs.Un;
        getThemedValue = _useTelemetryLegacy00HJs.Zr;
        prepareCommunityNodeDetailsViewStack = _useTelemetryLegacy00HJs._t;
        useNDVStore = _useTelemetryLegacy00HJs.a;
        useEvaluationStore = _useTelemetryLegacy00HJs.at;
        CanvasConnectionMode = _useTelemetryLegacy00HJs.br;
        flattenCreateElements = _useTelemetryLegacy00HJs.ct;
        useUsersStore = _useTelemetryLegacy00HJs.er;
        getPreBuiltAgentsCalloutWithDivider = _useTelemetryLegacy00HJs.ft;
        isValidNodeConnectionType = _useTelemetryLegacy00HJs.gr;
        isAINode = _useTelemetryLegacy00HJs.ht;
        usePostHog = _useTelemetryLegacy00HJs.i;
        STORES = _useTelemetryLegacy00HJs.ic;
        isTutorialTemplateId = _useTelemetryLegacy00HJs.jt;
        getTutorialTemplates = _useTelemetryLegacy00HJs.kt;
        isValidCanvasConnectionMode = _useTelemetryLegacy00HJs.mr;
        groupItemsInSections = _useTelemetryLegacy00HJs.mt;
        useWorkflowsStore = _useTelemetryLegacy00HJs.o;
        useNodeTypesStore = _useTelemetryLegacy00HJs.rt;
        finalizeItems = _useTelemetryLegacy00HJs.st;
        useTelemetry = _useTelemetryLegacy00HJs.t;
        getAiTemplatesCallout = _useTelemetryLegacy00HJs.ut;
        isVueFlowConnection = _useTelemetryLegacy00HJs.vr;
        useProjectsStore = _useTelemetryLegacy00HJs.wn;
        SampleTemplates = _useTelemetryLegacy00HJs.wt;
        sortNodeCreateElements = _useTelemetryLegacy00HJs.xt;
        searchNodes = _useTelemetryLegacy00HJs.yt;
      }, function (_constantsLegacy00RJs) {
        AI_CATEGORY_LANGUAGE_MODELS = _constantsLegacy00RJs.$;
        EDIT_IMAGE_NODE_TYPE = _constantsLegacy00RJs.$t;
        require__arrayIncludesWith = _constantsLegacy00RJs.Ai;
        TRANSFORM_DATA_SUBCATEGORY = _constantsLegacy00RJs.At;
        CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00RJs.Bt;
        LIMIT_NODE_TYPE = _constantsLegacy00RJs.Cn;
        XML_NODE_TYPE = _constantsLegacy00RJs.Cr;
        NODE_CREATOR_OPEN_SOURCES = _constantsLegacy00RJs.Ct;
        MARKDOWN_NODE_TYPE = _constantsLegacy00RJs.Dn;
        REGULAR_NODE_CREATOR_VIEW = _constantsLegacy00RJs.Dt;
        MANUAL_TRIGGER_NODE_TYPE = _constantsLegacy00RJs.En;
        CODE_NODE_TYPE = _constantsLegacy00RJs.Ht;
        CUSTOM_API_CALL_KEY = _constantsLegacy00RJs.I;
        AI_TRANSFORM_NODE_TYPE$1 = _constantsLegacy00RJs.It;
        CRYPTO_NODE_TYPE = _constantsLegacy00RJs.Jt;
        VIEWS = _constantsLegacy00RJs.No;
        AGGREGATE_NODE_TYPE = _constantsLegacy00RJs.Nt;
        AI_CODE_NODE_TYPE = _constantsLegacy00RJs.Pt;
        AI_CATEGORY_EMBEDDING = _constantsLegacy00RJs.Q;
        getNodeInputs = _constantsLegacy00RJs.Qi;
        SCHEDULE_TRIGGER_NODE_TYPE = _constantsLegacy00RJs.Qn;
        HUMAN_IN_THE_LOOP_CATEGORY = _constantsLegacy00RJs.St;
        isCommunityPackageName = _constantsLegacy00RJs.Ta;
        NodeConnectionTypes = _constantsLegacy00RJs.Ua;
        COMPRESSION_NODE_TYPE = _constantsLegacy00RJs.Ut;
        CONVERT_TO_FILE_NODE_TYPE = _constantsLegacy00RJs.Wt;
        AI_CATEGORY_CHAINS = _constantsLegacy00RJs.X;
        AI_TRANSFORM_NODE_TYPE = _constantsLegacy00RJs.Xa;
        RSS_READ_NODE_TYPE = _constantsLegacy00RJs.Xn;
        DATA_TABLE_NODE_TYPE = _constantsLegacy00RJs.Xt;
        AI_CATEGORY_AGENTS = _constantsLegacy00RJs.Y;
        REMOVE_DUPLICATES_NODE_TYPE = _constantsLegacy00RJs.Yn;
        AI_CATEGORY_DOCUMENT_LOADERS = _constantsLegacy00RJs.Z;
        DATETIME_NODE_TYPE = _constantsLegacy00RJs.Zt;
        IF_NODE_TYPE = _constantsLegacy00RJs._n;
        WEBHOOK_NODE_TYPE = _constantsLegacy00RJs._r;
        CORE_NODES_CATEGORY = _constantsLegacy00RJs._t;
        AI_CATEGORY_ROOT_NODES = _constantsLegacy00RJs.at;
        require__cacheHas = _constantsLegacy00RJs.bo;
        HELPERS_SUBCATEGORY = _constantsLegacy00RJs.bt;
        EXTRACT_FROM_FILE_NODE_TYPE = _constantsLegacy00RJs.cn;
        AI_CATEGORY_VECTOR_STORES = _constantsLegacy00RJs.ct;
        FORM_TRIGGER_NODE_TYPE = _constantsLegacy00RJs.dn;
        SUMMARIZE_NODE_TYPE = _constantsLegacy00RJs.dr;
        AI_NODE_CREATOR_VIEW = _constantsLegacy00RJs.dt;
        AI_CATEGORY_MCP_NODES = _constantsLegacy00RJs.et;
        AI_OTHERS_NODE_CREATOR_VIEW = _constantsLegacy00RJs.ft;
        HTTP_REQUEST_NODE_TYPE = _constantsLegacy00RJs.hn;
        AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = _constantsLegacy00RJs.ht;
        AI_CATEGORY_RETRIEVERS = _constantsLegacy00RJs.it;
        require__arrayIncludes = _constantsLegacy00RJs.ji;
        TRIGGER_NODE_CREATOR_VIEW = _constantsLegacy00RJs.jt;
        MERGE_NODE_TYPE = _constantsLegacy00RJs.kn;
        TEMPLATE_CATEGORY_AI = _constantsLegacy00RJs.kt;
        FILTER_NODE_TYPE = _constantsLegacy00RJs.ln;
        AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = _constantsLegacy00RJs.lt;
        HTML_NODE_TYPE = _constantsLegacy00RJs.mn;
        AI_UNCATEGORIZED_CATEGORY = _constantsLegacy00RJs.mt;
        PRE_BUILT_AGENTS_EXPERIMENT = _constantsLegacy00RJs.nc;
        EMAIL_SEND_NODE_TYPE = _constantsLegacy00RJs.nn;
        PRE_BUILT_AGENTS_MODAL_KEY = _constantsLegacy00RJs.ns;
        SPLIT_IN_BATCHES_NODE_TYPE = _constantsLegacy00RJs.or;
        AI_CATEGORY_TEXT_SPLITTERS = _constantsLegacy00RJs.ot;
        AI_SUBCATEGORY = _constantsLegacy00RJs.pt;
        NODE_MIN_INPUT_ITEMS_COUNT = _constantsLegacy00RJs.q;
        AI_CATEGORY_OUTPUTPARSER = _constantsLegacy00RJs.rt;
        require__baseFlatten = _constantsLegacy00RJs.si;
        EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE = _constantsLegacy00RJs.sn;
        SPLIT_OUT_NODE_TYPE = _constantsLegacy00RJs.sr;
        AI_CATEGORY_TOOLS = _constantsLegacy00RJs.st;
        EMAIL_IMAP_NODE_TYPE = _constantsLegacy00RJs.tn;
        EVALUATION_TRIGGER_NODE_TYPE = _constantsLegacy00RJs.to;
        SET_NODE_TYPE = _constantsLegacy00RJs.tr;
        AI_CATEGORY_MEMORY = _constantsLegacy00RJs.tt;
        DEFAULT_SUBCATEGORY = _constantsLegacy00RJs.vt;
        OTHER_TRIGGER_NODES_SUBCATEGORY = _constantsLegacy00RJs.wt;
        require__SetCache = _constantsLegacy00RJs.xo;
        HITL_SUBCATEGORY = _constantsLegacy00RJs.xt;
        FLOWS_CONTROL_SUBCATEGORY = _constantsLegacy00RJs.yt;
      }, function (_mergeLegacy00TJs) {
        require__baseUnary = _mergeLegacy00TJs.T;
        require__baseRest = _mergeLegacy00TJs.r;
        require_isArrayLikeObject = _mergeLegacy00TJs.u;
