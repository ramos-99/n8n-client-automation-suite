;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Dnvl_Nsb.js", "./src-legacy-ovK6Yepc.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-FGoq5HUU.js", "./useTelemetry-legacy-DDadbM-F.js", "./useToast-legacy-mgI0JreW.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js", "./useRunWorkflow-legacy-B9DJIVrX.js", "./NodeIcon-legacy-CdcdwuK1.js", "./isEmpty-legacy-Bp6_KD8L.js", "./dateFormatter-legacy-D3yx565r.js", "./AnimatedSpinner-legacy-CvzgRCW1.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, toDisplayString, createElementBlock, createCommentVNode, nextTick, unref, ref, createVNode, defineComponent, createBlock, toRef, mergeProps, Fragment, watch, normalizeStyle, withCtx, openBlock, withModifiers, renderList, createTextVNode, useTemplateRef, normalizeClass, createBaseVNode, shallowRef, useVirtualList, I18nT, useI18n, useThrottleFn, useTimestamp, N8nIconButton_default, N8nText_default, N8nIcon_default, N8nButton_default, N8nTooltip_default, __plugin_vue_export_helper_default, useRouter, require_get, isChatNode, addTokenUsageData, v4_default, require_upperFirst, emptyTokenUsageData, formatTokenUsageCount, injectWorkflowState, parse, useWorkflowsStore, useNodeTypesStore, useNodeHelpers, useToast, CHAT_TRIGGER_NODE_TYPE, createRunExecutionData, MANUAL_CHAT_TRIGGER_NODE_TYPE, NodeConnectionTypes, createEmptyRunExecutionData, LOGS_EXECUTION_DATA_THROTTLE_DURATION, parseErrorMetadata, Workflow, AGENT_LANGCHAIN_NODE_TYPE, PLACEHOLDER_EMPTY_WORKFLOW_ID, TOOL_EXECUTOR_NODE_NAME, useRunWorkflow, NodeIcon_default, require_isEmpty, toTime, toDayMonth, AnimatedSpinner_default, __vite_style__, import_get, import_isEmpty, ConsumedTokensDetails_vue_vue_type_script_setup_true_lang_default, ConsumedTokensDetails_default, LogsViewConsumedTokenCountText_vue_vue_type_script_setup_true_lang_default, LogsViewConsumedTokenCountText_default, _hoisted_1$1, LogsViewNodeName_vue_vue_type_script_setup_true_lang_default, name$1, LogsViewNodeName_vue_vue_type_style_index_0_lang_module_default, cssModules$2, LogsViewNodeName_default, import_upperFirst, _hoisted_1, LogsOverviewRow_vue_vue_type_script_setup_true_lang_default, container$1, background, selected, error, indent, connectorCurved, connectorStraight, icon, name, timeTook, statusTextIcon, startedAt, consumedTokens, compactErrorIcon, partialExecutionButton, openNdvButton, compact, unavailable, toggleButton, statusIcon, placeholder, LogsOverviewRow_vue_vue_type_style_index_0_lang_module_default, cssModules$1, LogsOverviewRow_default, LogsOverviewRows_vue_vue_type_script_setup_true_lang_default, tree, container, staticScrollBar, LogsOverviewRows_vue_vue_type_style_index_0_lang_module_default, cssModules, LogsOverviewRows_default;
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        addTokenUsageData = _useTelemetryLegacy00HJs.H;
        v4_default = _useTelemetryLegacy00HJs.Io;
        require_upperFirst = _useTelemetryLegacy00HJs.It;
        emptyTokenUsageData = _useTelemetryLegacy00HJs.U;
        formatTokenUsageCount = _useTelemetryLegacy00HJs.W;
        ...
        createEmptyRunExecutionData = _constantsLegacy00RJs.Vi;
        LOGS_EXECUTION_DATA_THROTTLE_DURATION = _constantsLegacy00RJs.dc;
        parseErrorMetadata = _constantsLegacy00RJs.gi;
        Workflow = _constantsLegacy00RJs.hi;
        AGENT_LANGCHAIN_NODE_TYPE = _constantsLegacy00RJs.qa;
