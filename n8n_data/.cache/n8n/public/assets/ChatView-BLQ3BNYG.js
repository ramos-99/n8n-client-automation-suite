...
import { I as useSpeechRecognition, L as useSpeechSynthesis, M as useMediaQuery, P as useScroll, gt as useI18n, j as useLocalStorage } from "./_MapCache-BMGgHHHp.js";
import { Et as N8nIconButton_default, Kn as N8nText_default, Wn as N8nHeading_default, Yn as N8nIcon_default, bt as require_markdown_it_link_attributes, ht as N8nLink_default, i as N8nScrollArea_default, it as useDeviceSupport, qn as N8nButton_default, wt as N8nInput_default, yt as N8nTooltip_default } from "./src-BSkvokO5.js";
...
import { Cn as useDocumentTitle, Io as v4_default, Ni as useUIStore, er as useUsersStore } from "./useTelemetry-B4fed6NY.js";
import { t as useToast } from "./useToast-CSbjPKgy.js";
import "./sanitize-html-CWrjF493.js";
import "./path-browserify-CcVVPqSM.js";
import { No as VIEWS, Qr as chatHubConversationModelSchema, Zr as PROVIDER_CREDENTIAL_TYPE_MAP, _s as LOCAL_STORAGE_CHAT_HUB_SELECTED_TOOLS, gs as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, mi as INodesSchema } from "./constants-CIzUKvWA.js";
...
import { t as VueMarkdown_default } from "./VueMarkdown-q2d3dalp.js";
...
import { c as isLlmProvider, f as unflattenModel, l as isLlmProviderModel, p as buildChatAttachmentUrl, r as findOneFromModelsResponse, t as useChatStore } from "./chat.store-DtNmTfLe.js";
...
var ChatMessageActions_default = /* @__PURE__ */ __plugin_vue_export_helper_default(ChatMessageActions_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ChatMessageActions_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-8fc94c16"]]);
...
var ChatMessage_vue_vue_type_style_index_0_lang_module_default = {
	...
	attachments: "_attachments_1j1m4_151",
			...
			return openBlock(), createElementBlock("form", {
				...
				!_ctx.selectedModel ? (openBlock(), createBlock(unref(N8nText_default), {
					...
					default: withCtx(() => [_ctx.isNewSession ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
						_cache[6] || (_cache[6] = createTextVNode(" Please ")),
						createBaseVNode("a", {
							href: "",
							onClick: _cache[0] || (_cache[0] = withModifiers(($event) => emit("selectModel"), ["prevent"]))
						}, "select a model"),
						_cache[7] || (_cache[7] = createTextVNode(" to start a conversation "))
					], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
						_cache[8] || (_cache[8] = createTextVNode(" Please ")),
						createBaseVNode("a", {
							href: "",
							onClick: _cache[1] || (_cache[1] = withModifiers(($event) => emit("selectModel"), ["prevent"]))
						}, "reselect a model"),
						_cache[9] || (_cache[9] = createTextVNode(" to continue the conversation "))
					], 64))]),
					_: 1
					...
					default: withCtx(() => [_ctx.isNewSession ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
						...
						_cache[11] || (_cache[11] = createTextVNode(" Please ")),
						createBaseVNode("a", {
							href: "",
