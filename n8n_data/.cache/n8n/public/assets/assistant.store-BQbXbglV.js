...
import { _t as isToolMessage, vt as isWorkflowUpdatedMessage } from "./src-BSkvokO5.js";
import { x as createEventBus, y as useRoute } from "./truncate-wYLRGs-P.js";
import { Bo as useSettingsStore, Bt as useCredentialsStore, Gt as getBuilderCredits, Ht as chatWithBuilder, Jt as useAIAssistantHelpers, Kr as getAuthTypeForNodeCredential, Kt as getSessionsMetadata, Ni as useUIStore, To as CREDENTIAL_EDIT_MODAL_KEY, Vt as chatWithAssistant, Wt as getAiSessions, a as useNDVStore, bn as injectWorkflowState, er as useUsersStore, ic as STORES, ji as codeNodeEditorEventBus, o as useWorkflowsStore, qr as getMainAuthField, qt as replaceCode, rt as useNodeTypesStore, t as useTelemetry, xi as stringSizeInBytes } from "./useTelemetry-B4fed6NY.js";
import { t as useToast } from "./useToast-CSbjPKgy.js";
import { Da as jsonParse, No as VIEWS, jo as EDITABLE_CANVAS_VIEWS, oi as require_pick, s as PLACEHOLDER_EMPTY_WORKFLOW_ID, t as DEFAULT_NEW_WORKFLOW_NAME, wa as deepCopy } from "./constants-CIzUKvWA.js";
import { g as assert, k as defineStore, r as useRootStore } from "./_baseOrderBy-CcXOJa87.js";
