...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-DDadbM-F.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js"], function (_export, _context) {
    ...
    var computed, ref, deleteDataTableApi, updateDataTableRowsApi, useSettingsStore, fetchDataTablesApi, getDataTableRowsApi, insertDataTableRowApi, deleteDataTableRowsApi, downloadDataTableCsvApi, addDataTableColumnApi, fetchDataTableGlobalLimitInBytes, moveDataTableColumnApi, uploadCsvFileApi, deleteDataTableColumnApi, createDataTableApi, useProjectsStore, updateDataTableApi, DATA_TABLE_STORE, getResourcePermissions, defineStore, useRootStore, reorderItem, useDataTableStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        computed = _vueRuntimeEsmBundlerLegacy003Js.C;
        ref = _vueRuntimeEsmBundlerLegacy003Js.It;
      }, function (_useTelemetryLegacy00HJs) {
        deleteDataTableApi = _useTelemetryLegacy00HJs.An;
        updateDataTableRowsApi = _useTelemetryLegacy00HJs.Bn;
        useSettingsStore = _useTelemetryLegacy00HJs.Bo;
        fetchDataTablesApi = _useTelemetryLegacy00HJs.Fn;
        getDataTableRowsApi = _useTelemetryLegacy00HJs.In;
        insertDataTableRowApi = _useTelemetryLegacy00HJs.Ln;
        deleteDataTableRowsApi = _useTelemetryLegacy00HJs.Mn;
        downloadDataTableCsvApi = _useTelemetryLegacy00HJs.Nn;
        addDataTableColumnApi = _useTelemetryLegacy00HJs.On;
        fetchDataTableGlobalLimitInBytes = _useTelemetryLegacy00HJs.Pn;
        moveDataTableColumnApi = _useTelemetryLegacy00HJs.Rn;
        uploadCsvFileApi = _useTelemetryLegacy00HJs.Vn;
        deleteDataTableColumnApi = _useTelemetryLegacy00HJs.jn;
        createDataTableApi = _useTelemetryLegacy00HJs.kn;
        useProjectsStore = _useTelemetryLegacy00HJs.wn;
        updateDataTableApi = _useTelemetryLegacy00HJs.zn;
      }, function (_constantsLegacy00RJs) {
        DATA_TABLE_STORE = _constantsLegacy00RJs.Pr;
