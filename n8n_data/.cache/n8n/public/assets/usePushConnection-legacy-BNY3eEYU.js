;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Dnvl_Nsb.js", "./useTelemetry-legacy-DDadbM-F.js", "./useToast-legacy-mgI0JreW.js", "./constants-legacy-ChKQ_dFa.js", "./assistant.store-legacy-CsRYRswL.js", "./_baseOrderBy-legacy-BPTF6GmT.js", "./useExternalHooks-legacy-9B_pHzUT.js", "./useWorkflowSaving-legacy-CbhrCJYz.js", "./useRunWorkflow-legacy-B9DJIVrX.js", "./schemaPreview.store-legacy-CZbn2cgF.js", "./aiTemplatesStarterCollection.store-legacy-CqGtCGB3.js", "./readyToRun.store-legacy-6tRSUNPW.js"], function (_export, _context) {
    "use strict";

    var ref, useI18n, getExecutionErrorToastConfiguration, isPrebuiltAgentTemplateId, useSettingsStore, useCredentialsStore, useDocumentTitle, useUIStore, getExecutionErrorMessage, getTriggerNodeServiceName, injectWorkflowState, parse, useWorkflowHelpers, isValidNodeConnectionType, sendGetWorkerStatus, codeNodeEditorEventBus, isTutorialTemplateId, globalLinkActionsEventBus, useWorkflowsStore, clearPopupWindowState, useNodeTypesStore, useTelemetry, SampleTemplates, useNodeHelpers, useToast, createRunExecutionData, generateNodesGraph, isCommunityPackageName, WORKFLOW_SETTINGS_MODAL_KEY, TRIMMED_TASK_DATA_CONNECTIONS_KEY, EVALUATION_TRIGGER_NODE_TYPE, useBuilderStore, useAssistantStore, defineStore, useRootStore, useExternalHooks, useWorkflowSaving, usePushConnectionStore, useRunWorkflow, useSchemaPreviewStore, useAITemplatesStarterCollectionStore, useReadyToRunStore, WORKER_HISTORY_LENGTH, STALE_SECONDS, useOrchestrationStore;
    ...
    */
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        createRunExecutionData = _constantsLegacy00RJs.Hi;
        ...
        TRIMMED_TASK_DATA_CONNECTIONS_KEY = _constantsLegacy00RJs.po;
