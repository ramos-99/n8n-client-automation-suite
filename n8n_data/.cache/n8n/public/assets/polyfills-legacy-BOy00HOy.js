(function() {
	...
	var require_function_uncurry_this_accessor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(object, key$1, method) {
			try {
				return uncurryThis$19(aCallable$11(Object.getOwnPropertyDescriptor(object, key$1)[method]));
			} catch (error) {}
		};
	}));
	var require_array_buffer_byte_length = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var ArrayBuffer$2 = globalThis$29.ArrayBuffer;
		var TypeError$4 = globalThis$29.TypeError;
		module.exports = ArrayBuffer$2 && uncurryThisAccessor$3(ArrayBuffer$2.prototype, "byteLength", "get") || function(O) {
			if (classof$8(O) !== "ArrayBuffer") throw new TypeError$4("ArrayBuffer expected");
			return O.byteLength;
		};
	}));
	var require_array_buffer_is_detached = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var DataView$2 = globalThis$28.DataView;
	...
	if (DESCRIPTORS$6 && !("detached" in ArrayBufferPrototype$1)) defineBuiltInAccessor$2(ArrayBufferPrototype$1, "detached", {
		configurable: true,
	...
	var require_array_buffer_not_detached = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(it) {
			if (isDetached(it)) throw new $TypeError$13("ArrayBuffer is detached");
			return it;
		};
	}));
	var require_environment = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = (function() {
			...
			if (globalThis$27.Bun && typeof Bun.version == "string") return "BUN";
			if (globalThis$27.Deno && typeof Deno.version == "object") return "DENO";
			if (classof$7(globalThis$27.process) === "process") return "NODE";
			if (globalThis$27.window && globalThis$27.document) return "BROWSER";
			return "REST";
		})();
	}));
	...
	var require_get_built_in_node_module = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(name) {
			if (IS_NODE$1) {
				try {
					return globalThis$26.process.getBuiltinModule(name);
				} catch (error) {}
				try {
	...
	var require_structured_clone_proper_transfer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var structuredClone$2 = globalThis$25.structuredClone;
		module.exports = !!structuredClone$2 && !fails$13(function() {
	...
	var require_detach_transferable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var structuredClone$1 = globalThis$24.structuredClone;
		var $ArrayBuffer = globalThis$24.ArrayBuffer;
		var $MessageChannel = globalThis$24.MessageChannel;
		var detach = false;
	...
	var require_array_buffer_transfer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var structuredClone = globalThis$23.structuredClone;
		var ArrayBuffer$1 = globalThis$23.ArrayBuffer;
		var DataView$1 = globalThis$23.DataView;
		var min$1 = Math.min;
		var ArrayBufferPrototype = ArrayBuffer$1.prototype;
		var DataViewPrototype = DataView$1.prototype;
		var slice$2 = uncurryThis$18(ArrayBufferPrototype.slice);
	...
	var require_iterators_core = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		if (!isObject$7(IteratorPrototype$3) || fails$11(function() {
			var test$1 = {};
	...
	var NativeIterator = globalThis$22[ITERATOR$2];
	var FORCED$4 = IS_PURE$8 || !isCallable$9(NativeIterator) || NativeIterator.prototype !== IteratorPrototype$2 || !fails$10(function() {
		NativeIterator({});
	});
	var IteratorConstructor = function Iterator$1() {
		anInstance$1(this, IteratorPrototype$2);
		if (getPrototypeOf$3(this) === IteratorPrototype$2) throw new $TypeError$11("Abstract class Iterator not directly constructable");
	};
	var defineIteratorPrototypeAccessor = function(key$1, value) {
		if (DESCRIPTORS$3) defineBuiltInAccessor$1(IteratorPrototype$2, key$1, {
			...
			set: function(replacement$1) {
				anObject$18(this);
				if (this === IteratorPrototype$2) throw new $TypeError$11("You can't redefine this property");
	...
	var require_function_uncurry_this_clause = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(fn) {
			if (classofRaw$1(fn) === "Function") return uncurryThis$17(fn);
		};
	}));
	var require_function_bind_context = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		var uncurryThis$16 = require_function_uncurry_this_clause();
		var aCallable$10 = require_a_callable();
		var NATIVE_BIND$1 = require_function_bind_native();
		var bind$3 = uncurryThis$16(uncurryThis$16.bind);
	...
	var require_get_iterator_method = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(it) {
			if (!isNullOrUndefined$1(it)) return getMethod$4(it, ITERATOR) || getMethod$4(it, "@@iterator") || Iterators[classof$6(it)];
		};
	}));
	var require_get_iterator = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(argument, usingIterator) {
			...
			if (aCallable$9(iteratorMethod)) return anObject$17(call$19(iteratorMethod, argument));
	...
	var require_iterator_helper_without_closing_on_early_error = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(METHOD_NAME, ExpectedError) {
			var Iterator$1 = globalThis$21.Iterator;
