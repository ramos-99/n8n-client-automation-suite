;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Dnvl_Nsb.js", "./truncate-legacy-FGoq5HUU.js", "./useTelemetry-legacy-DDadbM-F.js", "./useToast-legacy-mgI0JreW.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js", "./useExternalHooks-legacy-9B_pHzUT.js", "./templates.store-legacy-Coq6ILHm.js", "./focusPanel.store-legacy-BQl8FrOJ.js", "./executions.store-legacy-BSmK2wYL.js", "./usePinnedData-legacy-D9qWgS53.js", "./nodeCreator.store-legacy-Cz7MT2yw.js", "./useClipboard-legacy-oCuG5psd.js", "./folders.store-legacy-C0hwiE2m.js"], function (_export, _context) {
    "use strict";

    var __toESM, __commonJS, computed, nextTick, ref, shallowRef, useI18n, useLocalStorage, useRouter, createEventBus, useRoute, getExecutionErrorToastConfiguration, RemoveConnectionCommand, useSettingsStore, useCredentialsStore, tryToParseNumber, useHistoryStore, isChatNode, v4_default, RenameNodeCommand, useUIStore, ReplaceNodeParametersCommand, getNodesGroupSize, CanvasNodeRenderType, AddNodeCommand, useCanvasStore, useDataSchema, useNDVStore, getNewNodePosition, injectWorkflowState, CanvasConnectionMode, DEFAULT_VIEWPORT_BOUNDARIES, GRID_SIZE, useWorkflowHelpers, isValidNodeConnectionType, generateOffsets, useTagsStore, usePostHog, RemoveNodeCommand, MoveNodeCommand, CONFIGURATION_NODE_SIZE, useWorkflowsStore, PUSH_NODES_OFFSET, useNodeTypesStore, CONFIGURABLE_NODE_SIZE, useTelemetry, DEFAULT_NODE_SIZE, isPresent, useProjectsStore, AddConnectionCommand, useNodeHelpers, useToast, getNodeOutputs, NDV_IN_FOCUS_PANEL_EXPERIMENT, LOCAL_STORAGE_LOGS_SYNC_SELECTION, LOCAL_STORAGE_LOGS_PANEL_OPEN, generateNodesGraph, VIEWS, MCP_TRIGGER_NODE_TYPE, getNodeInputs, isCommunityPackageName, LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, NodeConnectionTypes, CANVAS_ZOOMED_VIEW_EXPERIMENT, getConnectionTypes, WEBHOOK_NODE_TYPE, getSubworkflowId, require_cloneDeep, FORM_TRIGGER_NODE_TYPE, getNodeParameters, UPDATE_WEBHOOK_ID_NODE_TYPES, require__baseUniq, EnterpriseEditionFeature, STICKY_NODE_TYPE, deepCopy, LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, defineStore, useRootStore, useExternalHooks, useTemplatesStore, useFocusPanelStore, useExecutionsStore, usePinnedData, mapCanvasConnectionToLegacyConnection, parseCanvasConnectionHandleString, mapLegacyConnectionToCanvasConnection, createCanvasConnectionHandleString, mapLegacyConnectionsToCanvasConnections, useNodeCreatorStore, useClipboard, useFoldersStore, chatEventBus, LOCAL_STORAGE_PANEL_HEIGHT, LOCAL_STORAGE_PANEL_WIDTH, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH, LOGS_PANEL_STATE, LOG_DETAILS_PANEL_STATE, useLogsStore, require_uniq, useExperimentalNdvStore, canvasEventBus, import_cloneDeep, import_uniq;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        getExecutionErrorToastConfiguration = _useTelemetryLegacy00HJs.$;
        RemoveConnectionCommand = _useTelemetryLegacy00HJs.Ar;
        ...
        ReplaceNodeParametersCommand = _useTelemetryLegacy00HJs.Nr;
        getNodesGroupSize = _useTelemetryLegacy00HJs.S;
        CanvasNodeRenderType = _useTelemetryLegacy00HJs.Sr;
        AddNodeCommand = _useTelemetryLegacy00HJs.Tr;
        useCanvasStore = _useTelemetryLegacy00HJs.Un;
        useDataSchema = _useTelemetryLegacy00HJs.Yt;
        ...
        RemoveNodeCommand = _useTelemetryLegacy00HJs.jr;
        MoveNodeCommand = _useTelemetryLegacy00HJs.kr;
        ...
        AddConnectionCommand = _useTelemetryLegacy00HJs.wr;
        useNodeHelpers = _useTelemetryLegacy00HJs.yn;
      }, function (_useToastLegacy00JJs) {
        useToast = _useToastLegacy00JJs.t;
      }, function (_constantsLegacy00RJs) {
        getNodeOutputs = _constantsLegacy00RJs.$i;
        NDV_IN_FOCUS_PANEL_EXPERIMENT = _constantsLegacy00RJs.$s;
        LOCAL_STORAGE_LOGS_SYNC_SELECTION = _constantsLegacy00RJs.Ds;
        LOCAL_STORAGE_LOGS_PANEL_OPEN = _constantsLegacy00RJs.Es;
        generateNodesGraph = _constantsLegacy00RJs.Ji;
        ...
        LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE = _constantsLegacy00RJs.Ts;
        NodeConnectionTypes = _constantsLegacy00RJs.Ua;
        CANVAS_ZOOMED_VIEW_EXPERIMENT = _constantsLegacy00RJs.Ys;
        getConnectionTypes = _constantsLegacy00RJs.Zi;
        WEBHOOK_NODE_TYPE = _constantsLegacy00RJs._r;
        getSubworkflowId = _constantsLegacy00RJs.aa;
        require_cloneDeep = _constantsLegacy00RJs.bi;
        FORM_TRIGGER_NODE_TYPE = _constantsLegacy00RJs.dn;
        getNodeParameters = _constantsLegacy00RJs.ea;
        UPDATE_WEBHOOK_ID_NODE_TYPES = _constantsLegacy00RJs.hr;
        require__baseUniq = _constantsLegacy00RJs.ki;
        ...
        LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL = _constantsLegacy00RJs.ws;
        ...
        mapCanvasConnectionToLegacyConnection = _nodeCreatorStoreLegacy01rJs.a;
        parseCanvasConnectionHandleString = _nodeCreatorStoreLegacy01rJs.l;
        mapLegacyConnectionToCanvasConnection = _nodeCreatorStoreLegacy01rJs.o;
