;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Dnvl_Nsb.js", "./src-legacy-ovK6Yepc.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-FGoq5HUU.js", "./useMessage-legacy-DNyf8RAT.js", "./useTelemetry-legacy-DDadbM-F.js", "./useToast-legacy-mgI0JreW.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js", "./useDebounce-legacy-C62RhzIG.js", "./useWorkflowSaving-legacy-CbhrCJYz.js", "./executions.store-legacy-BSmK2wYL.js", "./useRunWorkflow-legacy-B9DJIVrX.js", "./useCanvasOperations-legacy-jGTblFvL.js", "./folders.store-legacy-C0hwiE2m.js", "./NodeIcon-legacy-CdcdwuK1.js", "./dataTable.store-legacy-Cd3rJYtZ.js", "./useBugReporting-legacy-BLkzNkvI.js", "./uniqBy-legacy-DLCGw2JU.js", "./ProjectIcon-legacy-CuwXflBl.js", "./CredentialIcon-legacy-DNuWFM0o.js", "./FileSaver.min-legacy-CcqEXadD.js", "./useRecentResources-legacy-Bg5LG_aU.js", "./useWorkflowActivate-legacy-4PJyxlDm.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, toDisplayString, createElementBlock, createCommentVNode, unref, ref, createVNode, defineComponent, createBlock, openBlock, createTextVNode, normalizeClass, createBaseVNode, useI18n, N8nIcon_default, N8nKeyboardShortcut_default, __plugin_vue_export_helper_default, useRouter, useRoute, useMessage, useSettingsStore, useCredentialsStore, nodeViewEventBus, ProjectTypes, useUIStore, useSourceControlStore, executionRetryMessage, useWorkflowHelpers, useTagsStore, usePostHog, useActionsGenerator, useWorkflowsStore, useNodeTypesStore, useTelemetry, useProjectsStore, useToast, DATA_TABLE_DETAILS, DUPLICATE_MODAL_KEY, DATA_TABLE_VIEW, VIEWS, ABOUT_MODAL_KEY, MODAL_CONFIRM, getResourcePermissions, COMMAND_BAR_EXPERIMENT, WORKFLOW_SETTINGS_MODAL_KEY, EXECUTE_WORKFLOW_NODE_TYPE, WHATS_NEW_MODAL_KEY, IMPORT_WORKFLOW_URL_MODAL_KEY, PROJECT_DATA_TABLES, EnterpriseEditionFeature, isResourceLocatorValue, useRootStore, require_debounce, useWorkflowSaving, useExecutionsStore, useRunWorkflow, canvasEventBus, useCanvasOperations, useFoldersStore, NodeIcon_default, useDataTableStore, EXTERNAL_LINKS, useGlobalEntityCreation, useBugReporting, require_uniqBy, isIconOrEmoji, ProjectIcon_default, CredentialIcon_default, require_FileSaver_min, useRecentResources, useWorkflowActivate, __vite_style__, CommandBarItemTitle_vue_vue_type_script_setup_true_lang_default, container, title, suffix, action, shortcut, CommandBarItemTitle_vue_vue_type_style_index_0_lang_module_default, cssModules, CommandBarItemTitle_default, ITEM_ID$7, import_FileSaver_min, import_uniqBy, ITEM_ID$6, import_debounce$2, ITEM_ID$5, import_debounce$1, ITEM_ID$4, import_debounce, ITEM_ID$3, ITEM_ID$2, ITEM_ID$1, ITEM_ID;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        executionRetryMessage = _useTelemetryLegacy00HJs.X;
