...
import { gt as useI18n, j as useLocalStorage } from "./_MapCache-BMGgHHHp.js";
import { b as useRouter, x as createEventBus, y as useRoute } from "./truncate-wYLRGs-P.js";
import { $ as getExecutionErrorToastConfiguration, Ar as RemoveConnectionCommand, Bo as useSettingsStore, Bt as useCredentialsStore, Ci as tryToParseNumber, Cr as useHistoryStore, G as isChatNode, Io as v4_default, Mr as RenameNodeCommand, Ni as useUIStore, Nr as ReplaceNodeParametersCommand, S as getNodesGroupSize, Sr as CanvasNodeRenderType, Tr as AddNodeCommand, Un as useCanvasStore, Yt as useDataSchema, a as useNDVStore, b as getNewNodePosition, bn as injectWorkflowState, br as CanvasConnectionMode, d as DEFAULT_VIEWPORT_BOUNDARIES, f as GRID_SIZE, fn as useWorkflowHelpers, gr as isValidNodeConnectionType, h as generateOffsets, hn as useTagsStore, i as usePostHog, jr as RemoveNodeCommand, kr as MoveNodeCommand, l as CONFIGURATION_NODE_SIZE, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, rt as useNodeTypesStore, s as CONFIGURABLE_NODE_SIZE, t as useTelemetry, u as DEFAULT_NODE_SIZE, vi as isPresent, wn as useProjectsStore, wr as AddConnectionCommand, yn as useNodeHelpers } from "./useTelemetry-B4fed6NY.js";
import { t as useToast } from "./useToast-CSbjPKgy.js";
import { $i as getNodeOutputs, $s as NDV_IN_FOCUS_PANEL_EXPERIMENT, Ds as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Es as LOCAL_STORAGE_LOGS_PANEL_OPEN, Ji as generateNodesGraph, No as VIEWS, On as MCP_TRIGGER_NODE_TYPE, Qi as getNodeInputs, Ta as isCommunityPackageName, Ts as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Ua as NodeConnectionTypes, Ys as CANVAS_ZOOMED_VIEW_EXPERIMENT, Zi as getConnectionTypes, _r as WEBHOOK_NODE_TYPE, aa as getSubworkflowId, bi as require_cloneDeep, dn as FORM_TRIGGER_NODE_TYPE, ea as getNodeParameters, hr as UPDATE_WEBHOOK_ID_NODE_TYPES, ki as require__baseUniq, sc as EnterpriseEditionFeature, ur as STICKY_NODE_TYPE, wa as deepCopy, ws as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL } from "./constants-CIzUKvWA.js";
...
import { a as mapCanvasConnectionToLegacyConnection, l as parseCanvasConnectionHandleString, o as mapLegacyConnectionToCanvasConnection, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-Bzl27mKH.js";
