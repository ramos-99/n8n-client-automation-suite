...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-DDadbM-F.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js"], function (_export, _context) {
    ...
    var computed, reactive, useSettingsStore, getExternalSecrets, testExternalSecretsProviderConnection, reloadProvider, updateProvider, useRBACStore, connectProvider, getExternalSecretsProviders, getExternalSecretsProvider, EnterpriseEditionFeature, defineStore, useRootStore, useExternalSecretsStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        getExternalSecrets = _useTelemetryLegacy00HJs.Cs;
        testExternalSecretsProviderConnection = _useTelemetryLegacy00HJs.Ds;
        reloadProvider = _useTelemetryLegacy00HJs.Es;
        updateProvider = _useTelemetryLegacy00HJs.Os;
        useRBACStore = _useTelemetryLegacy00HJs.Qn;
        connectProvider = _useTelemetryLegacy00HJs.Ss;
        getExternalSecretsProviders = _useTelemetryLegacy00HJs.Ts;
        getExternalSecretsProvider = _useTelemetryLegacy00HJs.ws;
