;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Dnvl_Nsb.js", "./src-legacy-ovK6Yepc.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-FGoq5HUU.js", "./useMessage-legacy-DNyf8RAT.js", "./useTelemetry-legacy-DDadbM-F.js", "./useToast-legacy-mgI0JreW.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js", "./useExternalHooks-legacy-9B_pHzUT.js", "./useRunWorkflow-legacy-B9DJIVrX.js", "./usePinnedData-legacy-D9qWgS53.js", "./NodeIcon-legacy-CdcdwuK1.js", "./NDVEmptyState-legacy-C-3u2C0Y.js", "./Draggable-legacy-C_x_7ozS.js", "./TextWithHighlights-legacy-C8fykrgk.js", "./useTelemetryContext-legacy-C5WtVzwm.js", "./schemaPreview.store-legacy-CZbn2cgF.js", "./nodeTransforms-legacy-DgwkgU1m.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, toDisplayString, withScopeId, createElementBlock, createCommentVNode, nextTick, unref, guardReactiveProps, ref, h, shallowReactive, createVNode, markRaw, defineComponent, createBlock, mergeProps, Fragment, watch, renderSlot, normalizeStyle, withCtx, resolveDynamicComponent, openBlock, withModifiers, renderList, createTextVNode, useCssVars, toHandlers, resolveComponent, useSlots, pushScopeId, resolveDirective, popScopeId, normalizeClass, createBaseVNode, withDirectives, normalizeProps, I18nT, useI18n, computedAsync, N8nText_default, N8nIcon_default, N8nLink_default, N8nButton_default, N8nTooltip_default, __plugin_vue_export_helper_default, useRouter, useMessage, useSettingsStore, nodeViewEventBus, useUIStore, generateCodeForPrompt, useFlattenSchema, useDataSchema, environments_store_default, useNDVStore, injectWorkflowState, isEmpty, useWorkflowsStore, useNodeTypesStore, useTelemetry, useNodeHelpers, executionDataToJson, useToast, CHAT_TRIGGER_NODE_TYPE, SCHEMA_PREVIEW_DOCS_URL, MANUAL_TRIGGER_NODE_TYPE, ApplicationError, FROM_AI_PARAMETERS_MODAL_KEY, DateTime, AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, PLACEHOLDER_FILLED_AT_EXECUTION_TIME, MODAL_CONFIRM, createResultError, NodeConnectionTypes, AI_TRANSFORM_NODE_TYPE, AI_TRANSFORM_JS_CODE, WEBHOOK_NODE_TYPE, FORM_TRIGGER_NODE_TYPE, require_pick, EnterpriseEditionFeature, useRootStore, useExternalHooks, useRunWorkflow, usePinnedData, NodeIcon_default, Ln, gu, estree_exports, NDVEmptyState_default, Draggable_default, TextWithHighlights_default, MappingPill_default, useTelemetryContext, useSchemaPreviewStore, needsAgentInput, __vite_style__, _hoisted_1$3, _hoisted_2$2, _hoisted_3, _hoisted_4, _hoisted_5, _hoisted_6, VirtualSchemaHeader_vue_vue_type_script_setup_true_lang_default, VirtualSchemaHeader_default, _hoisted_1$2, _hoisted_2$1, VirtualSchemaItem_vue_vue_type_script_setup_true_lang_default, tooltip, VirtualSchemaItem_vue_vue_type_style_index_1_lang_module_default, cssModules, VirtualSchemaItem_default, isIE, script$2, _withId, _hoisted_1$1, VisibilityState, ObserveVisibility, config, regex, style, overflow, scroll, props, supportsPassive, opts, uid, script$2$1, _hoisted_1, _hoisted_2, script$1, script, estimateNumberOfTokens, calculateRemainingTokens, trimParentNodesSchema, trimInputSchemaProperties, getRowIndex, getColumnIndex, NODE_TEST_STEP_POPUP_COUNT_KEY, MAX_POPUP_COUNT, POPUP_UPDATE_DELAY, NodeExecuteButton_vue_vue_type_script_setup_true_lang_default, NodeExecuteButton_default, import_pick, VirtualSchema_vue_vue_type_script_setup_true_lang_default, VirtualSchema_default;
    //#endregion
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        generateCodeForPrompt = _useTelemetryLegacy00HJs.Ut;
        useFlattenSchema = _useTelemetryLegacy00HJs.Xt;
        ...
        Ln = _NDVEmptyStateLegacy021Js.i;
        gu = _NDVEmptyStateLegacy021Js.o;
        estree_exports = _NDVEmptyStateLegacy021Js.r;
      ...
      execute: function () {
        ...
        _export("t", VirtualSchema_default = /* @__PURE__ */__plugin_vue_export_helper_default(VirtualSchema_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-d8311f13"]])); //#endregion
      }
    };
  });
})();