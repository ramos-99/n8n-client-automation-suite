;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Dnvl_Nsb.js", "./src-legacy-ovK6Yepc.js", "./truncate-legacy-FGoq5HUU.js", "./useTelemetry-legacy-DDadbM-F.js", "./useToast-legacy-mgI0JreW.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, toDisplayString, createElementBlock, unref, ref, h, defineComponent, watch, openBlock, createTextVNode, createBaseVNode, useI18n, isToolMessage, isWorkflowUpdatedMessage, createEventBus, useRoute, useSettingsStore, useCredentialsStore, getBuilderCredits, chatWithBuilder, useAIAssistantHelpers, getAuthTypeForNodeCredential, getSessionsMetadata, useUIStore, CREDENTIAL_EDIT_MODAL_KEY, chatWithAssistant, getAiSessions, useNDVStore, injectWorkflowState, useUsersStore, STORES, codeNodeEditorEventBus, useWorkflowsStore, getMainAuthField, replaceCode, useNodeTypesStore, useTelemetry, stringSizeInBytes, useToast, jsonParse, VIEWS, EDITABLE_CANVAS_VIEWS, require_pick, PLACEHOLDER_EMPTY_WORKFLOW_ID, DEFAULT_NEW_WORKFLOW_NAME, deepCopy, assert, defineStore, useRootStore, ASSISTANT_ENABLED_VIEWS, BUILDER_ENABLED_VIEWS, import_pick, INFINITE_CREDITS, useBuilderStore, DEFAULT_CHAT_WIDTH, useChatPanelStateStore, ndvEventBus, _hoisted_1, AiUpdatedCodeMessage_vue_vue_type_script_setup_true_lang_default, AiUpdatedCodeMessage_default, READABLE_TYPES, useAssistantStore;
    //#endregion
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        isToolMessage = _srcLegacy007Js._t;
        isWorkflowUpdatedMessage = _srcLegacy007Js.vt;
        ...
        getBuilderCredits = _useTelemetryLegacy00HJs.Gt;
        chatWithBuilder = _useTelemetryLegacy00HJs.Ht;
        useAIAssistantHelpers = _useTelemetryLegacy00HJs.Jt;
        getAuthTypeForNodeCredential = _useTelemetryLegacy00HJs.Kr;
        getSessionsMetadata = _useTelemetryLegacy00HJs.Kt;
        useUIStore = _useTelemetryLegacy00HJs.Ni;
        CREDENTIAL_EDIT_MODAL_KEY = _useTelemetryLegacy00HJs.To;
        chatWithAssistant = _useTelemetryLegacy00HJs.Vt;
        getAiSessions = _useTelemetryLegacy00HJs.Wt;
        ...
        getMainAuthField = _useTelemetryLegacy00HJs.qr;
        replaceCode = _useTelemetryLegacy00HJs.qt;
        useNodeTypesStore = _useTelemetryLegacy00HJs.rt;
        useTelemetry = _useTelemetryLegacy00HJs.t;
        stringSizeInBytes = _useTelemetryLegacy00HJs.xi;
