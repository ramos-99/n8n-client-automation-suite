;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Dnvl_Nsb.js", "./truncate-legacy-FGoq5HUU.js", "./useTelemetry-legacy-DDadbM-F.js", "./useToast-legacy-mgI0JreW.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js", "./useExternalHooks-legacy-9B_pHzUT.js", "./useWorkflowSaving-legacy-CbhrCJYz.js", "./retry-legacy-CSXRWnZ-.js", "./executions.store-legacy-BSmK2wYL.js", "./useCanvasOperations-legacy-jGTblFvL.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watch, useI18n, useLocalStorage, require_get, RemoveConnectionCommand, useSettingsStore, useDocumentTitle, useHistoryStore, BulkCommand, displayForm, EnableNodeToggleCommand, AddNodeCommand, injectWorkflowState, useWorkflowHelpers, isEmpty, STORES, RemoveNodeCommand, useWorkflowsStore, useTelemetry, AddConnectionCommand, CanvasNodeDirtiness, useNodeHelpers, useToast, CHAT_TRIGGER_NODE_TYPE, createRunExecutionData, generateNodesGraph, LOCAL_STORAGE_RUN_DATA_WORKER, IN_PROGRESS_EXECUTION_ID, NodeConnectionTypes, createHeartbeatMessage, SINGLE_WEBHOOK_TRIGGERS, defineStore, useRootStore, useExternalHooks, useWorkflowSaving, retry, useExecutionsStore, useCanvasOperations, useHeartbeat, useReconnectTimer, useWebSocketClient, useEventSourceClient, proxyMarker, createEndpoint, releaseProxy, finalizer, throwMarker, isObject, transferHandlers, proxyCounter, proxyFinalizers, transferCache, worker, runDataWorker, usePushConnectionStore, LOCAL_STORAGE_AGENT_REQUESTS, useAgentRequestStore, import_get;
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        BulkCommand = _useTelemetryLegacy00HJs.Er;
        displayForm = _useTelemetryLegacy00HJs.J;
        EnableNodeToggleCommand = _useTelemetryLegacy00HJs.Or;
        ...
        LOCAL_STORAGE_RUN_DATA_WORKER = _constantsLegacy00RJs.Ms;
        IN_PROGRESS_EXECUTION_ID = _constantsLegacy00RJs.N;
        NodeConnectionTypes = _constantsLegacy00RJs.Ua;
        createHeartbeatMessage = _constantsLegacy00RJs.Xr;
