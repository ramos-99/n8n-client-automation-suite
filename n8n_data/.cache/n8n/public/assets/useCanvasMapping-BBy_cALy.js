...
import { _ as onKeyDown, _t as I18nT, gt as useI18n, it as useThrottleFn, ot as watchOnce, st as watchThrottled, y as onKeyUp } from "./_MapCache-BMGgHHHp.js";
import { Et as N8nIconButton_default, Kn as N8nText_default, T as N8nPopover_default, Yn as N8nIcon_default, ht as N8nLink_default, it as useDeviceSupport, nt as N8nActionDropdown_default, qn as N8nButton_default, y as N8nSticky_default, yt as N8nTooltip_default } from "./src-BSkvokO5.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { b as useRouter, n as truncateBeforeLast, x as createEventBus, y as useRoute } from "./truncate-wYLRGs-P.js";
import { D as TitledList_default } from "./ParameterInputList-_eEPZBtu.js";
import { A as _sfc_main$1, B as useGetPointerPosition, Bo as useSettingsStore, Cr as useHistoryStore, D as PanelPosition, E as NodeId, Ei as nodeViewEventBus, F as getBezierPath, G as isChatNode, I as getBoundsofRects, Io as v4_default, L as getConnectedEdges, M as _sfc_main$d, N as _sfc_main$f, Ni as useUIStore, O as Position, P as clamp, Qr as getTriggerNodeServiceName, R as getRectOfNodes, Sr as CanvasNodeRenderType, T as MarkerType, Tn as useSourceControlStore, V as useVueFlow, _n as environments_store_default, a as useNDVStore, bn as injectWorkflowState, br as CanvasConnectionMode, c as CONFIGURATION_NODE_RADIUS, f as GRID_SIZE, gr as isValidNodeConnectionType, j as _sfc_main$3, k as _sfc_main$4, m as calculateNodeSize, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, rt as useNodeTypesStore, t as useTelemetry, u as DEFAULT_NODE_SIZE, vi as isPresent, w as updateViewportToContainNodes, xr as CanvasNodeDirtiness, y as getMousePosition, yn as useNodeHelpers, z as getSmoothStepPath } from "./useTelemetry-B4fed6NY.js";
import { o as isOutsideSelected, s as sanitizeHtml, t as useToast } from "./useToast-CSbjPKgy.js";
import { $i as getNodeOutputs, Bt as CHAT_TRIGGER_NODE_TYPE, Ct as NODE_CREATOR_OPEN_SOURCES, Gi as mapConnectionsByDestination, Hs as CanvasNodeHandleKey, I as CUSTOM_API_CALL_KEY, No as VIEWS, Qi as getNodeInputs, Rn as NOT_DUPLICATABLE_NODE_TYPES, Ta as isCommunityPackageName, To as getResourcePermissions, Ua as NodeConnectionTypes, Us as CanvasNodeKey, Vo as EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY, Vs as CanvasKey, Ws as ExpressionLocalResolveContextSymbol, _i as extractReferencesInNodeExpressions, aa as getSubworkflowId, ca as isExecutable, cc as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, fi as buildAdjacencyList, fo as SEND_AND_WAIT_OPERATION, go as require_isEqual, gr as WAIT_NODE_TYPE, la as isNodeWithWorkflowSelector, mo as WAIT_INDEFINITELY, no as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, nr as SIMULATE_NODE_TYPE, pi as parseExtractableSubgraphSelection, rr as SIMULATE_TRIGGER_NODE_TYPE, un as FORM_NODE_TYPE, ur as STICKY_NODE_TYPE, us as WORKFLOW_EXTRACTION_NAME_MODAL_KEY } from "./constants-CIzUKvWA.js";
import { t as useStyles } from "./useStyles-CEyEF3kW.js";
import { t as useChatPanelStore } from "./chatPanel.store-Ch05Y2q_.js";
import { a as useTemplatesDataQualityStore, i as trackTemplatesClick, n as TemplateClickSource, r as isExtraTemplateLinksExperimentEnabled, t as useTemplatesStore } from "./templates.store-BxOFML5C.js";
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-B9ItD3Bj.js";
import { t as usePinnedData } from "./usePinnedData-jLHGG09j.js";
import { c as mapLegacyEndpointsToCanvasConnectionPort, i as insertSpacersBetweenEndpoints, l as parseCanvasConnectionHandleString, n as checkOverlap, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-Bzl27mKH.js";
import { t as getNodeIconSource } from "./nodeIcon-DFnw7yy2.js";
import { a as useLogsStore, i as useExperimentalNdvStore, t as useCanvasOperations } from "./useCanvasOperations-BcUlCnD4.js";
...
import { t as NodeSettings_default } from "./NodeSettings-ByfGaA3a.js";
