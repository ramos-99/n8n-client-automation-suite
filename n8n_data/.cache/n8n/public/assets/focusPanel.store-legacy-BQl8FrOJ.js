;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Dnvl_Nsb.js", "./truncate-legacy-FGoq5HUU.js", "./useTelemetry-legacy-DDadbM-F.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watchOnce, i18n, require_get, STORES, useWorkflowsStore, useNodeTypesStore, useStorage, jsonParse, extractFromAICalls, LOCAL_STORAGE_FOCUS_PANEL, FROM_AI_AUTO_GENERATED_MARKER, PLACEHOLDER_EMPTY_WORKFLOW_ID, defineStore, NODE_DENYLIST, PATH_DENYLIST, PROP_TYPE_DENYLIST, fromAIExtraProps, import_get, DEFAULT_PANEL_WIDTH, DEFAULT_FOCUS_PANEL_DATA, useFocusPanelStore;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        extractFromAICalls = _constantsLegacy00RJs.Si;
        LOCAL_STORAGE_FOCUS_PANEL = _constantsLegacy00RJs.Ss;
        FROM_AI_AUTO_GENERATED_MARKER = _constantsLegacy00RJs.io;
