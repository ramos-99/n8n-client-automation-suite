      ...
      execute: function () {
        _export("E", init_dist$1 = __esm({
          "../../../node_modules/.pnpm/vite-plugin-node-polyfills@0.24.0_rolldown-vite@7.1.16_@types+node@20.19.21_esbuild@0.2_86160ce2579410c2574f22fd74619205/node_modules/vite-plugin-node-polyfills/shims/process/dist/index.js": () => {
            ...
            _export("D", process$1 = /* @__PURE__ */getDefaultExportFromCjs(browserExports));
          }
        })); //#endregion
        //#region __vite-browser-external
        _export("T", require___vite_browser_external = /* @__PURE__ */__commonJS({
        ...
        _export("w", require_es_object_atoms = /* @__PURE__ */__commonJS({
        ...
        _export("C", require_range = /* @__PURE__ */__commonJS({
        ...
        _export("S", require_syntax = /* @__PURE__ */__commonJS({
        ...
        _export("x", require_type = /* @__PURE__ */__commonJS({
        ...
        _export("b", require_gopd = /* @__PURE__ */__commonJS({
        ...
        _export("y", require_es_define_property = /* @__PURE__ */__commonJS({
        ...
        _export("v", require_shams = /* @__PURE__ */__commonJS({
        ...
        _export("_", require_has_symbols = /* @__PURE__ */__commonJS({
        ...
        _export("g", require_function_bind = /* @__PURE__ */__commonJS({
        ...
        _export("h", require_functionApply = /* @__PURE__ */__commonJS({
        ...
        _export("m", require_actualApply = /* @__PURE__ */__commonJS({
        ...
        _export("p", require_call_bind_apply_helpers = /* @__PURE__ */__commonJS({
        ...
        _export("f", require_get_proto = /* @__PURE__ */__commonJS({
        ...
        _export("d", require_hasown = /* @__PURE__ */__commonJS({
        ...
        _export("u", require_get_intrinsic = /* @__PURE__ */__commonJS({
        ...
        _export("l", require_define_data_property = /* @__PURE__ */__commonJS({
        ...
        _export("c", require_has_property_descriptors = /* @__PURE__ */__commonJS({
        ...
        _export("s", require_set_function_length = /* @__PURE__ */__commonJS({
        ...
        _export("o", require_call_bind = /* @__PURE__ */__commonJS({
