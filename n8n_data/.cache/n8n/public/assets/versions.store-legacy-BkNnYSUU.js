;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-DDadbM-F.js", "./useToast-legacy-mgI0JreW.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js"], function (_export, _context) {
    "use strict";

    var computed, ref, useSettingsStore, useUIStore, getNextVersions, getWhatsNewSection, useUsersStore, STORES, useTelemetry, useStorage, useToast, jsonParse, VERSIONS_MODAL_KEY, LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES, WHATS_NEW_MODAL_KEY, LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT, defineStore, useRootStore, SEMVER_REGEX, useVersionsStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        getNextVersions = _useTelemetryLegacy00HJs.Uo;
        getWhatsNewSection = _useTelemetryLegacy00HJs.Wo;
        ...
        LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES = _constantsLegacy00RJs.js;
        WHATS_NEW_MODAL_KEY = _constantsLegacy00RJs.os;
        LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT = _constantsLegacy00RJs.ys;
