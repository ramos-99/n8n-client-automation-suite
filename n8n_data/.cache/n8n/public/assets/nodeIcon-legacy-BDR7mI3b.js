;
(function () {
  System.register(["./useTelemetry-legacy-DDadbM-F.js", "./constants-legacy-ChKQ_dFa.js", "./_baseOrderBy-legacy-BPTF6GmT.js"], function (_export, _context) {
    "use strict";

    var useUIStore, getThemedValue, isNodePreviewKey, useWorkflowsStore, useNodeTypesStore, removePreviewToken, isExpression, useRootStore, resolveIconExpression, getNodeIcon, getNodeIconUrl, getBadgeIconUrl, getNodeIconColor, prefixBaseUrl, getNodeBadgeIconSource, createFileIconSource, createNamedIconSource, getIconFromNodeTypeString;
    ...
    return {
      setters: [function (_useTelemetryLegacy00HJs) {
        ...
        isExpression = _constantsLegacy00RJs.Ni;
